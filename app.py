...
def read_zavala():
    ...
    <html>
        ...
        <body style="background-image: url('{{ url_for('static', filename='zavala_wp.jpg') }}')">
            <header style="text-align: center;">
                <h1>The Story of Zavala</h1>
                <h2><p>The Titan Vanguard</p></h2>
...
def read_cayde6():
    ...
    <html>
        ...
        <body style="background-image: url('{{ url_for('static', filename='cayde6_wp.jpg') }}')">
            <header style="text-align: center;">
                <h1>The Story of Cayde-6</h1>
                <h2><p>The Hunter Vanguard</p></h2>
...
def read_ikora():
    ...
    <html>
        ...
        <body style="background-image: url('{{ url_for('static', filename='ikora_wp.jpg') }}')">
            <header style="text-align: center;">
                <h1>The Story of Ikora</h1>
                <h2><p>The Warlock Vanguard</p></h2>
...
def read_anna():
    ...
    <html>
        ...
        <body style="background-image: url('{{ url_for('static', filename='anna_wp.jpg') }}')">
            <header style="text-align: center;">
                <h1>The Story of Anna</h1>
                <h2><p>The Gun Slinger</p></h2>
...
def read_elsie():
    ...
    <html>
        ...
        <body style="background-image: url('{{ url_for('static', filename='exo_wp.jpg') }}')">
            <header style="text-align: center;">
                <h1>The Story of Exo</h1>
                <h2><p>The Exo Stranger</p></h2>
